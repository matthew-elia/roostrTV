...
$sql = "INSERT INTO creators VALUES('', '$fullname', '$channelURL', '$email', NOW())";
...
$email_to = $email;
$email_from = 'automated-reply@roostr.tv';//<== update the email address
$email_subject = "Thanks for your interest in Roostr!";
$email_body = "Thanks for your interest in Roostr - we'll be in touch shortly. \n\n - Team Roostr";

$headers = "BCC: marco@roostr.tv, andy@roostr.tv \r\n";
